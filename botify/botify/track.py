...
class Catalog:
    ...
    def load(self, catalog_path, top_tracks_path):
        tracks_with_diverse_recs_path = None
        ...
        if tracks_with_diverse_recs_path is not None:
